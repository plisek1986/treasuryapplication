...
from .views import UserListView, UserCreateView, user_delete, UserView, UserEditView, UserAddAccountsView
...
urlpatterns = [
    ...
    path('user_add_account/<int:user_id>', UserAddAccountsView.as_view(), name='user-add-account'),

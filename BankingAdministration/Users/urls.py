...
from .views import UserListView, UserCreateView, user_delete, UserView, UserEditView, UserAddAccount
...
urlpatterns = [
    ...
    path('user_add_account/<int:user_id>', UserAddAccount.as_view(), name='user-add-account'),
